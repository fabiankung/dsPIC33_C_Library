...
//
//  (c) Copyright 2017-2018, Fabian Kung Wai Lee, Selangor, MALAYSIA
//  All Rights Reserved  
//   
//////////////////////////////////////////////////////////////////////////////////////////////
//
...
unsigned int    gunDeadBandThres = 3 ; // Deadband threshold, speed setting less than this magnitude will be ignored.
//
...
///               PWM pulses is inversely proportional to the rotational speed needed.  Another I/O pin is used 
